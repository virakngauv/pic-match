...
export const CARD_LAYOUT_TEMPLATES: readonly CardLayoutTemplate[] = [
  ...
  template('borealis', [
    ...
    [0.271, -0.71, 0.102, 26, 0.17],
    [0.663, 0.372, 0.088, 136, 0.17],
    [-0.461, -0.301, 0.076, -15, 0.17],
  ]),
  template('cascade', [
    ...
    [0.303, -0.697, 0.102, 19, 0.17],
    [-0.199, -0.53, 0.088, -155, 0.17],
    [0.202, -0.315, 0.076, 52, 0.17],
  ]),
  template('delta', [
  ...
  template('glimmer', [
    ...
    [-0.67, 0.341, 0.118, -61, 0.178],
    [-0.756, -0.073, 0.102, -9, 0.17],
    [0.294, 0.701, 0.088, 121, 0.17],
    [0.709, -0.12, 0.076, -39, 0.17],
  ]),
  template('harbor', [
  ...
  template('isotope', [
    ...
    [-0.077, -0.691, 0.155, -127, 0.234],
    [0.569, -0.272, 0.135, 101, 0.204],
    [0.38, 0.616, 0.118, 67, 0.178],
    [-0.749, 0.127, 0.102, -23, 0.17],
    [0.381, -0.658, 0.088, -101, 0.17],
    [-0.356, 0.164, 0.076, 94, 0.17],
  ]),
  template('juno', [
